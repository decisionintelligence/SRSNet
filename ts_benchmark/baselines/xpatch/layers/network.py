...
class Network(nn.Module):
    def __init__(self, seq_len, pred_len, patch_len, stride, padding_patch, srs_dropout, srs_hidden_size, srs_alpha,
                 srs_pos):
        ...
        self.fc1 = SRS(self.dim, self.patch_len, self.stride, self.seq_len, srs_dropout, srs_hidden_size, srs_alpha, srs_pos)
